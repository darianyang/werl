...
class ODLDPropagator(WESTPropagator):
    ...
    def __init__(self, rc=None):
        ...
        self.reflect_at_x0 = 0
        self.reflect_at_x = 1
        self.reflect_at_y0 = 0
        self.reflect_at_y = 1
    ...
    def _reflect(self, coord_array, min_bound, max_bound):
        ...
        log.info(f'COORD_ARRAY: {coord_array}')
        ...
        log.info(f'COORD_ARRAY_POST_REF: {coord_array}')
        return coord_array
