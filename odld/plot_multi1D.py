...
h5_list = ["hk1b.h5", "hk10b.h5", "mab10b.h5", "wevo.h5", "lcas.h5", "west_lowS.h5"]
...
def odld_1d_potential(A=2, B=10, C=0.5, x0=0):
    ...
    # negative plot is accurate to the simulation results
